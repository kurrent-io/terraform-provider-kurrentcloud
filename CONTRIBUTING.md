# Contributing to `terraform-provider-kurrentcloud`
...
`terraform-provider-kurrentcloud` is licensed under the [MPL-v2][mpl2] license. By submitting a pull request, you represent that you have right to license your contribution to Event Store Ltd and the community, and that by submitting a patch your contributions are licensed under the MPL-v2.0 license.
...
- The version of `terraform-provider-kurrentcloud` - including a commit SHA if using a local build
...
[conduct]:  https://github.com/kurrent-io/terraform-provider-kurrentcloud/tree/master/CODE-OF-CONDUCT.md
[mpl2]: https://www.mozilla.org/en-US/MPL/2.0/
[commit-template]: https://github.com/kurrent-io/terraform-provider-kurrentcloud/tree/master/.git.commit.template
[github-repo]: https://github.com/kurrent-io/terraform-provider-kurrentcloud
